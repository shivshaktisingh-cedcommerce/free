      ...
      <div id="component1">
          ...
          <div id="expense">
              ...
              {this.state.arr1grocery.map((data,index)=>{
                       return <li><input type="text" value={data.item} readOnly/><input type="number" value={data.amt} readOnly /><button className="editbtn" id="1" value={index} onClick={this.editrow}>Edit</button><button className="deletebtn" onClick={this.deleterow} id="1" value={index}>Delete</button></li>
                 })}
                  ...
                  {this.state.arr1veggies.map((data,index)=>{
                       return <li><input type="text" value={data.item} readOnly/><input type="number" value={data.amt} readOnly /><button className="editbtn" id="2" value={index} onClick={this.editrow}>Edit</button><button className="deletebtn" onClick={this.deleterow} id="2" value={index}>Delete</button></li>
                 })}
                  ...
                  {this.state.arr1travelling.map((data,index)=>{
                       return <li><input type="text" value={data.item} readOnly/><input type="number" value={data.amt} readOnly /><button className="editbtn" id="3" value={index} onClick={this.editrow}>Edit</button><button className="deletebtn" onClick={this.deleterow} id="3" value={index}>Delete</button></li>
                 })}
                  ...
                  {this.state.arr1miscellaneous.map((data,index)=>{
                       return <li><input type="text" value={data.item} readOnly/><input type="number" value={data.amt} readOnly /><button className="editbtn" id="4" value={index} onClick={this.editrow}>Edit</button><button className="deletebtn" onClick={this.deleterow} id="4" value={index}>Delete</button></li>
                 })}
          ...
          <div id="income">
              <h3 id="h3income">All income</h3>
                  ...
                  {this.state.arr1income.map((data,index)=>{
                       return <li><input type="text" value={data.item} readOnly/><input type="number" value={data.amt} readOnly /><button className="editbtn" id="5" value={index} onClick={this.editrow}>Edit</button><button className="deletebtn" onClick={this.deleterow} id="5" value={index}>Delete</button></li>
                 })}
          </div>
